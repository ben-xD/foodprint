...
test('getCarbonFootprintFromBarcode: barcode of a product that is already in the database', async() => {
    ...
    let response = await barcode.getCarbonFootprintFromBarcode(oranges_each_barcode);
...
test('getCarbonFootprintFromBarcode: barcode of a product who is not in the database' +
    ...
    let response = await barcode.getCarbonFootprintFromBarcode(buckwheat_barcode_barcode);
...
test('getCarbonFootprintFromBarcode: barcode of a product which is not a food', async() => {
    ...
    let response = await barcode.getCarbonFootprintFromBarcode(soap_barcode);
...
test('getCarbonFootprintFromBarcode: barcode of a product which has no information', async() => {
    ...
    let response = await barcode.getCarbonFootprintFromBarcode(no_info_barcode_barcode);
...
test('getCarbonFootprintFromBarcode: barcode of a product who is not in the database' +
    ...
    let response = await barcode.getCarbonFootprintFromBarcode(tiramisu_barcode);
