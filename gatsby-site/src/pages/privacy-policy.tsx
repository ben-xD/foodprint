...
const PrivacyPolicy = (props: PageProps) => (
  <Layout>
    ...
    <body>
      <p>
        Foodprint built the Foodprint app as a Free app. This SERVICE is
        provided by Foodprint at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Foodprint unless otherwise
      ...
      <p>
        ...
        but not limited to Food history, email, name. The information that I
      ...
      <p>This policy is effective as of 2020-05-15</p>
      <p>
        <strong>Contact Us</strong>
      </p>
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at support@orth.uk.
      </p>
    </body>
  </Layout>
)
